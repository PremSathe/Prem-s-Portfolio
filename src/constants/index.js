import { GeekRider, edureka } from "../assets/images";
import {
    car,
    contact,
    css,
...
export const projects = [
    {
        ...
        description: "Prem's Restaurant React app offers a seamless and user-friendly interface for patrons to explore the restaurans menu, place orders, and enjoy a streamlined dining experience. With responsive design and intuitive navigation, it enhances the customer's interaction with the restaurant's offerings.",
    ...
    },
    {
        ...
        name: 'GPT3-clone',
        description: "The GPT-3 clone using React harnesses the power of OpenAI's language model to create an interactive and dynamic application. Users can experience advanced natural language understanding and generation capabilities, showcasing the potential of GPT-3 within a React-based interface.",
    ...
    // {
        // iconUrl: snapgram,
        // theme: 'btn-back-pink',
        // name: 'MERN Stack Social Media App',
        // // // description: '#',
        // link: '#',
    // },
];